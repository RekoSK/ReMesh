 ...
 * `elevation = (R*256 + G + B/256) - 32768` metres. Tiles are cached decoded in memory and as
 * PNG bytes on disk, so repeated computes over the same area are offline after the first fetch.
 */
